...
ตัวอย่างการใช้งานปิยะทอนในสถานการณ์จริง
...
3. **ใช้เครื่องมือเรียงไฟล์**

```bash
python sort_files.pi --โฟลเดอร์="เอกสาร" --นามสกุล="pdf"
```

```{note}
ตัวอย่างเหล่านี้เป็นเพียงพื้นฐาน สามารถปรับแต่งเพิ่มเติมตามความต้องการได้
```
