...
```mermaid
graph TD
    A[โค้ดต้นฉบับปิยะทอน] --> B[การแยกวิเคราะห์คำ]
    B --> C{ประเภทโทเคน}
...
```mermaid
graph TD
    A[โค้ดต้นฉบับ ปิยะทอน] --> B[การวิเคราะห์คำ]
    B --> C[การแบ่งโทเค็น]
    C --> D[การวิเคราะห์แยกแยะโทเค็น]
    D --> E[AST ของ ปิยะทอน]
    E --> F{การแปลง AST}
    ...
    AA -->|ใช่| V
    AA -->|ไม่| AB[AST ของ ปิยะทอน]
    AB --> AC[การสร้างโค้ด]
    AC --> AD[โค้ดต้นฉบับ ปิยะทอน]
```
